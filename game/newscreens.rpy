...
screen ResetButton():
    if reset == 0:
        ...
        imagebutton:
            ...
            action Play("sound", "sfx_ui_click1.ogg"), SetVariable("coffee", 0), SetVariable('Espresso', 0), SetVariable("Milk", 0), SetVariable("Cinnamon", 0), SetVariable("Chocolate", 0), SetVariable("Pumpkin", 0), SetVariable("steam", 0), SetVariable("whip_cream", 0), SetVariable("foam", 0), SetVariable("creamer", 0), SetVariable("ExtraShot", 0)
...
screen ConfirmButton():
    if order == 1:
        imagebutton:
            ...
            action SetVariable("makingdrink", 1), Play("sound", "sfx_ui_click1.ogg"), Play("sound2", "sfx_room_coffee_pour.ogg"), SetVariable("reset", 0)
    else:
        imagebutton:
            xalign 0.97 yalign 0.57
...
screen NextButton():
    if pagenum == 1:
        imagebutton:
            ...
            action SetVariable("pagenum", 2),Hide("MilkButton"), Hide("CinnamonButton"),Hide("ChocolateButton"), Hide("PumpkinButton"),Hide("CoffeeButton"), Hide("EspressoButton"), Show("foamButton"), Show("espressoSHOTButton"), Show("whipButton"), Show("creamerButton"), Show("steamedMilk"), Show("Ingredients2"), Play("sound", "sfx_ui_click1.ogg")
    else:
        imagebutton:
            xalign 0.9882 yalign 0.1846
...
screen Prevbutton():
    if pagenum == 1:
        ...
        imagebutton:
            ...
            action SetVariable("pagenum", 1),Show("MilkButton"), Show("CinnamonButton"),Show("ChocolateButton"), Show("PumpkinButton"), Hide("foamButton"), Hide("espressoSHOTButton"), Hide("whipButton"), Hide("creamerButton") , Hide("steamedMilk"), Show("CoffeeButton"), Show("EspressoButton"), Hide("Ingredients2"), Play("sound", "sfx_ui_click1.ogg")
...
screen CoffeeButton():
    if coffee == 1:
        ...
        imagebutton:
            ...
            action SetVariable("coffee", 1), SetVariable('Espresso', 0), Play("sound", "sfx_ui_click1.ogg")
...
screen EspressoButton():
    if Espresso == 1:
        ...
        imagebutton:
            ...
            action SetVariable("Espresso", 1), SetVariable("coffee", 0), Play("sound", "sfx_ui_click1.ogg")
...
screen steamedMilk():
    if steam == 1:
        ...
        imagebutton:
            ...
            action SetVariable("steam", 1), Play("sound", "sfx_ui_click1.ogg")
screen MilkButton():
    if Milk == 1:
        imagebutton:
        ...
        imagebutton:
            ...
            action SetVariable("Milk", 1), Play("sound", "sfx_ui_click1.ogg")
...
screen CinnamonButton():
    if Cinnamon == 1:
        ...
        imagebutton:
            ...
            action SetVariable("Cinnamon", 1), Play("sound", "sfx_ui_click1.ogg")
...
screen ChocolateButton():
    if Chocolate == 1:
        ...
        imagebutton:
            ...
            action SetVariable("Chocolate", 1), Play("sound", "sfx_ui_click1.ogg")
...
screen PumpkinButton():
    if Pumpkin == 1:
        ...
        imagebutton:
            ...
            action SetVariable("Pumpkin", 1), Play("sound", "sfx_ui_click1.ogg")
...
screen foamButton():
    if foam == 1:
        ...
        imagebutton:
            ...
            action SetVariable("foam", 1), Play("sound", "sfx_ui_click1.ogg")
...
screen espressoSHOTButton():
    if ExtraShot == 1:
        ...
        imagebutton:
            ...
            action SetVariable("ExtraShot", 1), Play("sound", "sfx_ui_click1.ogg")
...
screen creamerButton():
    if creamer == 1:
        ...
        imagebutton:
            ...
            action SetVariable("creamer", 1), Play("sound", "sfx_ui_click1.ogg")
...
screen whipButton():
    if whip_cream == 1:
        ...
        imagebutton:
            ...
            action SetVariable("whip_cream", 1), Play("sound", "sfx_ui_click1.ogg")
